        ...
        <div class="card" style="border-radius: 25px; background-color: #70000B;">
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1 my-wrapper-login pt-5">
                ...
                <form class="mx-1 mx-md-4" method="POST" action="{{ route('login') }}">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="email" id="email" class="form-control mb-1 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus/>
                                  @error('email')
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input id="password" type="password" class="form-control mb-1 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                          ...
                          @enderror
                          <label class="col-md-4 col-form-label" for="email">{{ __('Password') }}</label>
                    </div>
                  </div>
              ...
              <div class="image-container my-wrapper-login  col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

              <img src="{{ Vite::asset('resources/img/hunters tooth and talon_intero.png') }}" alt="immagine">
              </div>
            </div>
          </div>
        </div>
