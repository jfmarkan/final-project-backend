    ...
    <div class="container d-flex flex-column">
        ...
        <div class="my_stats-card bg-transparent my_header-glass">
            <div class="card-body my_bg-glass rounded text-center">
                <p class="card-title p-3">Edit Profile</p>
                <form action="{{ route('admin.update', auth::user()) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @method('PUT')
                        ...
                        <div class="px-2 d-flex flex-wrap justify-content-around mb-3">
                            @foreach ($specializations as $specialization)
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" id="specialization" name="specialization[]" value="{{ $specialization->id }}" @if((auth::user()->hunter)->specializations->contains($specialization->id)) checked @endif>
                        ...
                        <div class="row d-flex justify-content-center px-2">
                            <button class="btn my-btn align-self-center" type="submit">
                                <span class="icon">
